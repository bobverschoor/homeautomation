...
class HueBridgeTest(unittest.TestCase):
    ...
    def test_get_all_lights(self):
        ...
        licht = lichten.pop()
        self.assertEqual("00:17:88:01:04:50:54:7d-0b", licht.unique_id)
        licht = lichten.pop()
        self.assertEqual("Danica plafond lamp", licht.naam)
        licht = lichten.pop()
...
testdata = \
    ...
    '"uniqueid": "00:17:88:01:04:ba:17:0d-0b", "swversion": "1.88.1", "swconfigid": "06BB83C8", ' \
    ...
    '"uniqueid": "00:17:88:01:04:12:74:2e-0b", "swversion": "1.29.0_r21169", "swconfigid": "FF6681C4", "productid": ' \
    ...
    '"functional", "direction": "omnidirectional"}, "uniqueid": "00:17:88:01:04:12:8a:fd-0b", "swversion": ' \
    ...
    'light", "name": "Danica plafond lamp", "modelid": "LTC001", "manufacturername": "Signify Netherlands B.V.", ' \
    ...
    '"safety", "configured": true}}, "uniqueid": "00:17:88:01:03:35:fe:2d-0b", "swversion": "1.88.1", "swconfigid": ' \
    ...
    '"readytoinstall", "lastinstall": "2020-09-23T18:07:38"}, "type": "Color temperature light", "name": "Dimitri ' \
    ...
    '"uniqueid": "00:17:88:01:04:50:54:7d-0b", "swversion": "1.50.2_r30933", "swconfigid": "19789229", "productid": ' \
