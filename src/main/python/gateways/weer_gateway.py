        ...
        if self.weerdata.error != "":
            ...
            for property_name, value in self.weerdata.get_properties():
                if property_name == "temperatuur":
                    meetwaarde = Meetwaarde(eenheid="gradencelsius", waarde=value, tags=convertlist2tags(
                    ...
                    meetwaarde = Meetwaarde(eenheid="mm/h", waarde=value, tags=convertlist2tags(
